  ...
  return (
    <div className="applicantsPage">
      ...
      <div className="applicantsPage__main">
        <p>
          Уфимский филиал ФГБОУ ВО «ВГУВТ» объявляет дополнительный приём на
          заочную форму обучения по договорам об образовании. Набор ведется по
          образовательной программе высшего образования — программа специалитета
          по специальности 26.05.06. Эксплуатация судовых энергетических
          установок. Приём документов осуществляется до 20 ноября 2023 г. по
          адресу: г.Уфа, ул. Ахметова 275, каб. № 7 <br />
          Тел: 7(347)215-14-00, 89174966495.
        </p>
        <Image
